...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.hisabtracker.app"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  signingConfigs {
    create("release") {
      ...
      if (keystoreFile.exists()) {
        ...
        storePassword = System.getenv("STORE_PASSWORD") ?: "placeholderpass"
        keyAlias = System.getenv("KEY_ALIAS") ?: "upload"
        keyPassword = System.getenv("KEY_PASSWORD") ?: "placeholderpass"
      }
    }
    create("debugConfig") {
